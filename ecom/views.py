...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            #send_mail(str(name)+' || '+str(email),+' Message from Customer is:' +message+' \n\n Regards\n \nTweedTrend', settings.EMAIL_HOST_USER, settings.EMAIL_RECEIVING_USER, fail_silently = False)
            #send_mail(f"TweedTrend - Customer Query - {current_date}",f"TweedTrend",f"\n Hey Vijay, \n\n I hope this email finds you well. We wanted to inform you that we have received a new customer query on our website, TweedTrend. The details of the message are as follows: \n\n Recived Message from Customer: {name}\n\n Message : {message} \n\n Customer Mail-Id : {email}\n\n Regards,\n TweedTrend",settings.EMAIL_HOST_USER,[settings.EMAIL_RECEIVING_USER],fail_silently=False)
            send_mail(
                f"TweedTrend - Customer Query - {current_date}",
                f"\n Hello Vijay, \n\n I hope this email finds you well. We wanted to inform you that we have received a new customer query on our website, TweedTrend. The details of the message are as follows: \n\n Received Message from Customer: {name}\n\n Message: {message} \n\n Customer Mail-Id: {email}\n\n Regards,\n TweedTrend",
